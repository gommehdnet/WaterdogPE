 ...
 * @version 1.0
 */
public class BedrockCodec622 extends BedrockCodec618 {

    @Override
    public ProtocolVersion getProtocol() {
        return ProtocolVersion.MINECRAFT_PE_1_20_40;
    }

    @Override
    public void buildCodec(BedrockPacketCodec.Builder builder) {
        super.buildCodec(builder);
        builder.helper(BedrockPacketHelper_v622.INSTANCE);

        builder.deregisterPacket(DisconnectPacket.class);
        builder.registerPacket(DisconnectPacket.class, DisconnectSerializer_v622.INSTANCE, 5);
    }
}