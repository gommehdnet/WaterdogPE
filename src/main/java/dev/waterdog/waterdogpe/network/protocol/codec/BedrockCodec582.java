 ...
 * @version 1.0
 */
public class BedrockCodec582 extends BedrockCodec575 {

    @Override
    public ProtocolVersion getProtocol() {
        return ProtocolVersion.MINECRAFT_PE_1_19_80;
    }

    @Override
    public void buildCodec(BedrockPacketCodec.Builder builder) {
        super.buildCodec(builder);
        builder.helper(BedrockPacketHelper_v582.INSTANCE);

        builder.deregisterPacket(StartGamePacket.class);
        builder.registerPacket(StartGamePacket.class, StartGameSerializer_v582.INSTANCE, 11);

        builder.deregisterPacket(RequestChunkRadiusPacket.class);
        builder.registerPacket(RequestChunkRadiusPacket.class, RequestChunkRadiusSerializer_v582.INSTANCE, 69);
    }
}